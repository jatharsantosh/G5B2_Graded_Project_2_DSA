package org.greatlearning.Main;

import java.util.Scanner;

import org.greatlearning.FindIndex.FindIndex;
import org.greatlearning.services.*;
...
public class Driver {
	...
	public static void main(String args[]) {
		...
		/*
		 * Test cases int arr[] = {1,2,3,8,9,10,4,5,7,6}; int arr[] = {3,1,2}; int arr[]
		 * = {4,5,1,2,3};
		 */
		int[] arr = new int[N];
		int day, curr_idx = 0;
